...
class DetailThriftCategoryController extends GetxController {
  ...
  getThriftProuctByCategory(String? categoryID) async {
    try {
      var url = Uri.http(ipAddress, 'ecom2_api/getThriftProductbyCategory');
